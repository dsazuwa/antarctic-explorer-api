...
public record CruiseLineDTO(
  ...
  public CruiseLineDTO(
      CruiseLine cruiseLine, List<com.antarctic.explorer.api.model.Expedition> expeditions) {
    this(
        cruiseLine.getId(),
        cruiseLine.getName(),
...
record Expedition(
    ...
    String photoUrl) {
  public Expedition(com.antarctic.explorer.api.model.Expedition expedition) {
    this(
        expedition.getId(),
